...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://source.skip.tools/skip-foundation.git", from: "0.5.15"),
        .package(url: "https://source.skip.tools/skip-ui.git", from: "0.6.4"),
        .package(url: "https://source.skip.tools/skip-web.git", from: "0.3.1"),
